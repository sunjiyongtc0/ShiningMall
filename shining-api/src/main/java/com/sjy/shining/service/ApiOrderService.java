...
import com.sjy.shining.dao.ApiAddressMapper;
import com.sjy.shining.dao.ApiCartMapper;
import com.sjy.shining.dao.ApiCouponMapper;
import com.sjy.shining.dao.ApiOrderGoodsMapper;
import com.sjy.shining.dao.ApiOrderMapper;
import com.sjy.shining.entity.AddressVo;
import com.sjy.shining.entity.BuyGoodsVo;
import com.sjy.shining.entity.CartVo;
import com.sjy.shining.entity.CouponVo;
import com.sjy.shining.entity.OrderGoodsVo;
import com.sjy.shining.entity.OrderVo;
import com.sjy.shining.entity.ProductVo;
import com.sjy.shining.entity.UserVo;
import com.sjy.shining.utils.CommonUtil;
...
//        AddressVo addressVo = jsonParam.getObject("checkedAddress",AddressVo.class);
        ...
        if (type.equals("cart")) {
            ...
            BuyGoodsVo goodsVo = null;//(BuyGoodsVo) J2CacheUtils.get(J2CacheUtils.SHOP_CACHE_NAME, "goods" + loginUser.getUserId());
