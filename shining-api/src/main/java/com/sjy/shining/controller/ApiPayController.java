...
import com.sjy.shining.service.ApiOrderGoodsService;
import com.sjy.shining.service.ApiOrderService;
import com.sjy.shining.utils.ApiBaseAction;
import com.sjy.shining.utils.wechat.WechatRefundApiResult;
import com.sjy.shining.utils.wechat.WechatUtil;
...
public class ApiPayController extends ApiBaseAction {
    ...
    public Object orderQuery(@LoginUser UserVo loginUser, Integer orderId) {
        ...
        if ("SUCCESS".equals(trade_state)) {
            ...
            // 重新查询 正在支付中
            Integer num = null;//(Integer) J2CacheUtils.get(J2CacheUtils.SHOP_CACHE_NAME, "queryRepeatNum" + orderId + "");
            if (num == null) {
