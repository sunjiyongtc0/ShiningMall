...
public class RegionCacheUtil implements InitializingBean {
    ...
    @PostConstruct
    public  void init() {
        sysRegionEntityList=sysRegionService.selectAll();
//        SysRegionDao regionDao = SpringContextUtils.getBean(SysRegionDao.class);
//        if (null != regionDao) {
//            sysRegionEntityList = regionDao.selectAll();//.queryList(new HashMap<String, Object>());
//            System.out.println("sysRegionEntityList.size()===========>>>>>>>>>>"+sysRegionEntityList.size());
//        }
    }
