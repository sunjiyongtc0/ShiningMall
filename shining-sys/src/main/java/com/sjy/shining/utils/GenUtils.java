...
import com.sjy.shining.entity.ColumnEntity;
import com.sjy.shining.entity.TableEntity;
...
public class GenUtils {
    ...
    private static List<String> getTemplates() {
        ...
        templates.add("templates/vm/Dao.xml.vm");
        ...
        templates.add("templates/vm/list.html.vm");
        templates.add("templates/vm/list.js.vm");
        templates.add("templates/vm/menu.sql.vm");
        return templates;
    }
