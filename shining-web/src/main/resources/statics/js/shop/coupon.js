...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            ...
            var c=vm.coupon;
            var sendEndDate = new Date(c.sendEndDate);
            var sendStartDate = new Date(c.sendStartDate);
            var useEndDate = new Date(c.useEndDate);
            var useStartDate = new Date(c.useStartDate);

            c.sendEndDate=sendEndDate.getTime();
            c.sendStartDate=sendStartDate.getTime();
            c.useEndDate=useEndDate.getTime();
            c.useStartDate=useStartDate.getTime();
            Ajax.request({
                type: "POST",
                url: url,
